    ...
    public void postConstruct() {
        if (em.find(Customer.class, 1l) == null) {
            try {
                ...
                Product pA = new Product("Amber Jersey Pleated Dress", new BigDecimal(169), "Light TENCEL™ fabric : skin-friendly, soft texture, high breathability, made from sustainable wood sources.", imagelink, "CLOTHING", new BigDecimal(20),new BigDecimal(4));
                Product pB = new Product("Raffles Asymmetrical Wide Leg Pants", new BigDecimal(159), "This mid waist and wide legs pants was designed to suit any occasion." , imagelink, "CLOTHING",new BigDecimal(20),new BigDecimal(4));
                Product pC = new Product("Bugis Stitch Maxi Dress", new BigDecimal(189), "This dress that comes in 2 colours was designed to suit any occasion.", imagelink, "CLOTHING",new BigDecimal(20),new BigDecimal(4));
                Product pD = new Product("Raffles X-line Midi Dress", new BigDecimal(199), "Soft woven fabric made of TENCEL™ lyocell with decorative seams", imagelink, "CLOTHING",new BigDecimal(20),new BigDecimal(4));
                Product pE = new Product("Raffles Blend Dress", new BigDecimal(179), "Jersey made of TENCEL™ modal and and skirt belnd with Woven TENCEL, designed with a V-neckline" , imagelink, "CLOTHING",new BigDecimal(20),new BigDecimal(4));
                Product pF = new Product("U-Shaped Back Draped Dress", new BigDecimal(159), "Made from Tencel - known as environment-friendly fabrics. Designed with a bowtie and a side open slit.", imagelink, "CLOTHING",new BigDecimal(20),new BigDecimal(4));
                Product pG = new Product("Amber Belted Maxi Dress", new BigDecimal(199), "A timeless piece, this dress will last a lifetime.  Featuring front panel details and a removable waist tie.", imagelink, "CLOTHING",new BigDecimal(20),new BigDecimal(4));
                Product pH = new Product("Handmade Natural Soap (Tamarind/ Rice)", new BigDecimal(10), "Our NO. 1 BESTSELLER hand-crafted soap is made using high-quality tamarind and rice.", imagelink, "CRAFTS",new BigDecimal(20),new BigDecimal(4)); //Olive Tree
                Product pI = new Product("Assorted Crocheted Angels", new BigDecimal(25), "Bring home these large decorative assorted crocheted angels crafted by our volunteer Aunty Nancy!", imagelink, "CRAFTS",new BigDecimal(20),new BigDecimal(4)); //Olive Tree
                Product pJ = new Product("Elastic Collar Shirt", new BigDecimal(139), "TENCEL is a natural fibre which is degradable.  Special properties include: enhanced breathability &  gentle on the skin.", imagelink, "CLOTHING",new BigDecimal(20),new BigDecimal(4));
                Product pK = new Product("Sunshine Chips", new BigDecimal(5), "We took the spectrum of sunlight, separated it and vacuum fried them into chips. No artificial colourings or preservatives!", imagelink, "FOOD",new BigDecimal(20),new BigDecimal(4)); //boxgreen
                Product pL = new Product("Grounded Sea Salt Peanut Butter Jar", new BigDecimal(10), "Roasted peanuts grounded twice for extra smoothness with heart-healthy coconut oil and a dash of salt to bring the flavours home. ", imagelink, "CRAFTS",new BigDecimal(20),new BigDecimal(4)); //boxgreen
                Product pM = new Product("Thai Mountain Espresso", new BigDecimal(75), "A world class single origin coffee, backed by multiple awards, our Organic Espresso is the perfect espresso shot you’ve been looking for.", imagelink, "FOOD",new BigDecimal(20),new BigDecimal(4)); //noharmdone
                Product pN = new Product("Thai Iced Tea", new BigDecimal(10), "Earthy black Ceylon tea leaves brewed to give you an authentic orange coloured tea that'll take your senses to the bustling streets of Bangkok.", imagelink, "FOOD",new BigDecimal(20),new BigDecimal(4));//noharmdone
                Product pO = new Product("Choco Kopi", new BigDecimal(8), "For Mondays, hangovers, make ups, breakups, late nights, early starts, rainy days… A hug in a mug. Our toasty Kopi-o with a malty chocolate infusion. ", imagelink, "FOOD",new BigDecimal(20),new BigDecimal(4)); //noharmdone
                Product pP = new Product("Gula Melaka Kopi", new BigDecimal(8), "We've blended our signature Kopi-o with caramelised coconut sugar, giving your favourite brew a decadent twist." , imagelink, "FOOD",new BigDecimal(20),new BigDecimal(4));
                Product pQ = new Product("Personalised Photo Dome", new BigDecimal(170), "Our Signature Preserved Flower Dome is meticulously handcrafted using long-lasting premium flowers. Make a lasting impression with this thoughtful gift, personalized with a memorable photo of your loved one.", imagelink, "OTHERS",new BigDecimal(20),new BigDecimal(4)); //bloomback
                Product pR = new Product("Handmade Natural Soap (Lemon Grass)", new BigDecimal(10), "Our NO. 1 BESTSELLER hand-crafted soap is made using high-quality lemongrass.", imagelink, "CRAFTS",new BigDecimal(20),new BigDecimal(4)); //olive tree
                Product pS = new Product("Personalised Birthstone Bag Charm", new BigDecimal(75), "This bag charm is crafted using long-lasting premium flowers and completed with a meaningful birthstone.", imagelink, "OTHERS",new BigDecimal(20),new BigDecimal(4));//bloomback
                Product pT = new Product("Handmade Natural Soap (Roselle/ Rice Milk)", new BigDecimal(10), "Our NO. 1 BESTSELLER hand-crafted soap is made using high-quality roselle and rice milk.", imagelink, "CRAFTS",new BigDecimal(20),new BigDecimal(4)); //olive tree
